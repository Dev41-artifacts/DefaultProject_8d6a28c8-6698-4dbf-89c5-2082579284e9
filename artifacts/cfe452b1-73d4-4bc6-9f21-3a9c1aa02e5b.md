...
<head>
    ...
    <title id="page-title">BuildFlow CRM - Construction Industry Solutions</title>
...
<script>
    const config = {
        pageTitle: "BuildFlow CRM - Construction Industry Solutions",
        theme: {
            mode: 'light',
            light: {
                bgColor: '#F9FAFB',
        ...
        main: {
            ...
            description: "BuildFlow CRM is specifically designed for construction professionals, offering an intuitive platform that simplifies project management, client relationships, and business growth - all in one user-friendly solution.",
            features: [
                {
                    ...
                    description: "Capture and digitize contact information and deals instantly with our advanced photo recognition system."
                },
                {
                    icon: '<svg class="w-6 h-6 text-emerald-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4"></path></svg>',
                    iconBg: 'bg-emerald-100',
                    title: "User-Friendly Interface",
                    description: "Clean, intuitive design that's easy to navigate, perfect for teams new to digital solutions."
                },
                {
                    icon: '<svg class="w-6 h-6 text-emerald-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path></svg>',
                    iconBg: 'bg-emerald-100',
                    title: "Construction-Specific Tools",
                    description: "Features tailored for construction industry workflows, from project tracking to client management."
                }
            ]
        },
        iframe: {
            title: "Interactive Demo",
            subtitle: "Experience BuildFlow CRM in action",
            src: "https://demo.buildflow-crm.com"
        },
        footer: {
            text: "© 2025 BuildFlow CRM. Empowering Construction Businesses with Smart Solutions."
        }
    };
